  ...
  return (
    <div className="space-y-4 mt-4">
      ...
      <ImportDialog
        title="Import Leads"
        entityName="Leads"
        requiredColumns={["name", "email", "phone", "company", "source", "value", "status", "city", "country", "notes"]}
        templateData="John Doe,john@example.com,+919999988888,Acme Corp,direct,50000,new,Mumbai,India,Follow up soon"
        open={showImport}
